...
module Controller
  class BaseController < Sinatra::Base
    RESTRICTED_PATHS = %w[/type-of-properties /api/my-account /filter-properties /download /download/all /opt-out/name /opt-out/received /opt-out/certificate-details].freeze
