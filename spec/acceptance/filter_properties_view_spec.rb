  ...
  describe "get .get-energy-certificate-data.epb-frontend/filter-properties" do
    ...
    context "when selecting multiple councils" do
      ...
      it "redirects to the request-received-confirmation with the right params" do
        ...
        expect(valid_response_with_multiple_councils.headers["Location"]).to eq("http://get-energy-performance-data/request-received-confirmation?property_type=domestic&from-year=2023&from-month=January&to-year=2025&to-month=February&ratings%5B%5D=A&ratings%5B%5D=B&local-authority%5B%5D=Birmingham&local-authority%5B%5D=Adur&parliamentary-constituency%5B%5D=Select+all&download_count=123&email=test%40email.com")
      end
    end
    ...
    context "when selecting multiple constituencies" do
      ...
      it "redirects to the request-received-confirmation with the right params" do
        ...
        expect(valid_response_with_multiple_constituencies.headers["Location"]).to eq("http://get-energy-performance-data/request-received-confirmation?property_type=domestic&from-year=2023&from-month=January&to-year=2025&to-month=February&ratings%5B%5D=A&ratings%5B%5D=B&parliamentary-constituency%5B%5D=Ashford&parliamentary-constituency%5B%5D=Cardiff&local-authority%5B%5D=Select+all&download_count=123&email=test%40email.com")
      end
    end
